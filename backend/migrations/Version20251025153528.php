 ...
 */
final class Version20251025153528 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE forgotten_password_request ADD user_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_C02FC44DA76ED395');
        $this->addSql('ALTER TABLE forgotten_password_request DROP user_id');
    }
}
